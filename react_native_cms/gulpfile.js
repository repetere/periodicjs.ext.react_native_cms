...
var aliasify = require('aliasify'); // Used to convert ES6 & JSX to ES5
...
var config = {
  js: {
    src: './index.ios.js',
    watch: './**/*.js',
    outputDir: '../public/web/build/',
    outputFile: 'index.ios_build.js',
  },
};
...
function bundle(bundler) {
  ...
  bundler
    ...
    .pipe(source('index.ios.js')) // Set source name
